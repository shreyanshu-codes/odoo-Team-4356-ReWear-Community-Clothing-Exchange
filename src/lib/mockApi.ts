...
const initializeLocalStorage = () => {
  ...
  if (!localStorage.getItem('rewear_users')) {
    const initialUsers: User[] = [
      ...
      { id: 4, email: "mayankdl1972@gmail.com", password: "password123!", name: "Mayank", points: 500, role: "user", avatarUrl: "https://placehold.co/100x100.png" },
    ];
  ...
  if (!localStorage.getItem('rewear_items')) {
    const initialItems: Item[] = [
      ...
      { id: 6, title: "Men's Regular Casual Pants", description: "Comfortable and versatile casual pants for men, suitable for everyday wear.", userId: 3, images: ["https://m.media-amazon.com/images/I/91qdN8vNgAL._UY1100_.jpg"], category: "Pants", type: "Casual", size: "L", condition: "Used", tags: ["casual", "men"], status: "available", points: 140 },
      { id: 7, title: "Butterfly Print Top for Women", description: "Stylish and modern top for women with a subtle butterfly print.", userId: 2, images: ["https://i.pinimg.com/474x/f7/a8/f2/f7a8f24c1bb94860f3915760ceb02515.jpg"], category: "Tops", type: "Casual", size: "M", condition: "Gently Used", tags: ["stylish", "print"], status: "swapped", points: 100 },
      { id: 8, title: "Men Jeans Denim", description: "Classic blue denim jeans for men. A staple for any wardrobe.", userId: 3, images: ["https://tigc.in/cdn/shop/files/compress_0421-cpdnm-azure__1.jpg?v=1720758011"], category: "Pants", type: "Casual", size: "L", condition: "New", tags: ["jeans", "denim", "men"], status: "available", points: 250 },
      { id: 9, title: "Bomber Jacket", description: "Stylish and comfortable bomber jacket, perfect for a cool look.", userId: 2, images: ["https://assets.myntassets.com/h_1440,q_100,w_1080/v1/assets/images/25080860/2023/10/26/eb8530aa-292d-4b84-9e49-ee56a12999ce1698304530703-boohooMAN-Bomber-Jacket-5211698304530502-1.jpg"], category: "Jackets", type: "Casual", size: "M", condition: "Gently Used", tags: ["jacket", "bomber"], status: "available", points: 300 },
      { id: 10, title: "Pure Cotton Collar Shirt", description: "A classic pure cotton collar shirt from Marks & Spencer.", userId: 3, images: ["https://assets.digitalcontent.marksandspencer.app/image/upload/w_600,h_780,q_auto,f_auto,e_sharpen/SD_03_T11_0730A_Z0_X_EC_0"], category: "Tops", type: "Formal", size: "XL", condition: "New", tags: ["shirt", "formal", "cotton"], status: "available", points: 280 },
      { id: 11, title: "Jack & Jones Solid Casual Shirt", description: "A stylish beige casual shirt for men from Jack & Jones.", userId: 2, images: ["https://assets.myntassets.com/h_1440,q_100,w_1080/v1/assets/images/24577032/2023/8/21/9d687d8f-8dfd-4653-9b33-4c3af2b3d3651692623856872JackJonesMenBeigeOpaqueCasualShirt1.jpg"], category: "Tops", type: "Casual", size: "M", condition: "Gently Used", tags: ["shirt", "casual", "men"], status: "available", points: 240 }
    ];
