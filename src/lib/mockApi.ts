...
const initializeLocalStorage = () => {
  ...
  if (!localStorage.getItem('rewear_items')) {
    const initialItems: any[] = [
      ...
      { id: 4, title: "Breathable Baggy Cargo Pants", description: "Light and breathable baggy cargo pants. Ideal for a relaxed, utilitarian style.", userId: 'john-mock-id', images: ["https://littleboxindia.com/cdn/shop/files/28d_d3808282-d2fc-45e4-88eb-23cb4910b970.jpg?v=1740750143"], category: "Pants", type: "Casual", size: "S", condition: "pending", points: 150 },
      ...
      { id: 7, title: "Butterfly Print Top for Women", description: "Stylish and modern top for women with a subtle butterfly print.", userId: 'jane-mock-id', images: ["https://i.pinimg.com/474x/f7/a8/f2/f7a8f24c1bb94860f3915760ceb02515.jpg"], category: "Tops", type: "Casual", size: "M", condition: "swapped", points: 100 },
