...
const initializeLocalStorage = () => {
  ...
  if (!localStorage.getItem('rewear_items')) {
    const initialItems: Item[] = [
      ...
      { id: 8, title: "Men Jeans Denim", description: "Classic blue denim jeans for men. A staple for any wardrobe.", userId: 3, images: ["https://tigc.in/cdn/shop/files/compress_0421-cpdnm-azure__1.jpg?v=1720758011"], category: "Pants", type: "Casual", size: "L", condition: "New", tags: ["jeans", "denim", "men"], status: "available", points: 25 },
